...
/* @var $model BaseApp\hrm\modules\EmployeeManage\search\EmployeeSearch */
...
<div class="form-employee-search">
    ...
    <?= $form->field($model, 'user_id')->widget(\kartik\widgets\Select2::classname(), [
        'data' => \yii\helpers\ArrayHelper::map(\BaseApp\ums\modules\UserBase\User::find()->orderBy('id')->asArray()->all(), 'id', 'username'),
